...
class Host : public GenericHashEntry {
 ...
 public:
  ...
  inline void incNumEchoReplyFlows(bool as_server)       { if(stats) stats->incNumEchoReplyFlows(as_server); };
  inline void incNumEchoFlows(bool as_server)            { if(stats) stats->incNumEchoFlows(as_server); };
  ...
  inline u_int32_t getTotalNumEchoReplyOutgoingFlows() const        { return stats->getTotalEchoReplyNumFlowsAsClient(); };
  inline u_int32_t getTotalNumEchoReplyIncomingFlows() const        { return stats->getTotalEchoReplyNumFlowsAsServer(); };
  inline u_int32_t getTotalNumEchoOutgoingFlows() const             { return stats->getTotalEchoNumFlowsAsClient(); };
  inline u_int32_t getTotalNumEchoIncomingFlows() const             { return stats->getTotalEchoNumFlowsAsServer(); };
